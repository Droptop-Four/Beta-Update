...
@echo All distributables finished successfully. Press any key to push Release-Update to GitHub.
...
@echo Release-update pushed successfully. Press any key to start Droptop setup...
PAUSE
%4 !WriteKeyValue Variables Page 0 %5Droptop\Other\Startup\Start.ini"
