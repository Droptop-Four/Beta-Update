...
@REM %SYSTEMROOT%\System32\WindowsPowerShell\v1.0\powershell.exe [console]::beep(800,200); [console]::beep(800,320)
@REM @echo Press any key to push all remaining versions to GitHub.
@REM PAUSE
@REM @echo Are you sure? Press any key to continue.
@REM PAUSE
...
@echo Beta-update pushed successfully. Press any key to start Droptop...
PAUSE
%4 !WriteKeyValue Variables Page 0 %5Droptop\Other\Startup\Start.ini"
%4 !ActivateConfig "Droptop\Dropdownbar" "Dropdownbar.ini"
