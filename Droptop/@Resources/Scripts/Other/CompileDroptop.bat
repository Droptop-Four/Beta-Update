...
%4 !WriteKeyValue Variables ActionTimer.StartAnimation.Steps 8 %5Droptop\@Resources\GlobalVar\UserSettings.inc"
%4 !WriteKeyValue Variables ActionTimer.StartAnimation.StepsNum 4 %5Droptop\@Resources\GlobalVar\UserSettings.inc"
