...
Start-Process -FilePath "`"$programPath`"" -ArgumentList "!WriteKeyValue","Variables","DropdownFontName","`"$fontName`"","`"${skinspath}Droptop\@Resources\Themes\${themeNum}Settings.inc`""
